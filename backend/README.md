...
## Project Structure
    ...
    ├── testapiautosetting_123646  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_123646`
...
2. Clone this repo and `cd testapiautosetting_123646`
